        ...
        class SpecialBasket {
            ...
            constructor({ sessid, items, config = {} }) {
                ...
                if (window.JCCatalogItem) {
                    window.JCCatalogItem.prototype.changeInfo = this.handleOfferChange(window.JCCatalogItem.prototype.changeInfo);
                }
                if (window.JCCatalogElement) {
                    window.JCCatalogElement.prototype.changeInfo = this.handleOfferChange(window.JCCatalogElement.prototype.changeInfo);
                }
                SpecialBasket.instance = this;
            }
